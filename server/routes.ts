  ...
  return `
    ...
    <body>
      ...
      <div class="disclaimer">
        <strong>⚠️ Important Note:</strong> These questions and model answers are AI-generated practice materials. 
        They may not reflect your actual interview questions. Use them as a guide for preparation and always verify information independently.
      </div>
